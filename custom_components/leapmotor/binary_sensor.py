...
OPTIONAL_BINARY_SENSOR_PATHS = {
    ...
    "parking_brake_active": "diagnostics.parking_brake_active",
    ...
    "healthy_charging_enabled": "diagnostics.healthy_charging_enabled",
    "charging_schedule_cancelled_once": "diagnostics.charging_schedule_cancelled_once",
...
BINARY_SENSOR_DESCRIPTIONS: tuple[LeapmotorBinarySensorEntityDescription, ...] = (
    ...
    LeapmotorBinarySensorEntityDescription(
        key="parking_brake_active",
        translation_key="parking_brake_active",
        icon="mdi:car-brake-parking",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data["diagnostics"].get("parking_brake_active"),
    ),
    LeapmotorBinarySensorEntityDescription(
        key="battery_heating",
    ...
    LeapmotorBinarySensorEntityDescription(
        key="healthy_charging_enabled",
        translation_key="healthy_charging_enabled",
        icon="mdi:battery-heart-variant",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data["diagnostics"].get("healthy_charging_enabled"),
    ),
    LeapmotorBinarySensorEntityDescription(
        key="charging_schedule_cancelled_once",
        translation_key="charging_schedule_cancelled_once",
        icon="mdi:calendar-remove",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data["diagnostics"].get("charging_schedule_cancelled_once"),
    ),
    LeapmotorBinarySensorEntityDescription(
...
async def async_setup_entry(
    ...
    if entry.data.get(CONF_REGION) == REGION_CN:
        from .cn.binary_sensor import async_setup_entry as cn_async_setup_entry
