...
BUTTON_SPECS: tuple[RemoteActionSpec, ...] = (
    ...
    RemoteActionSpec(
        action=REMOTE_CTL_SENTRY_MODE_ON,
        translation_key="sentry_mode_on",
        icon="mdi:shield-car",
        method_name="sentry_mode_on",
        service_name=REMOTE_CTL_SENTRY_MODE_ON,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_SENTRY_MODE_OFF,
        translation_key="sentry_mode_off",
        icon="mdi:shield-off",
        method_name="sentry_mode_off",
        service_name=REMOTE_CTL_SENTRY_MODE_OFF,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_CHARGE_START,
        translation_key="start_charging",
        icon="mdi:battery-charging-high",
        method_name="start_charging",
        service_name=REMOTE_CTL_CHARGE_START,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_CHARGE_STOP,
        translation_key="stop_charging",
        icon="mdi:battery-off-outline",
        method_name="stop_charging",
        service_name=REMOTE_CTL_CHARGE_STOP,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_HEALTHY_CHARGING_ON,
        translation_key="healthy_charging_on",
        icon="mdi:battery-heart",
        method_name="healthy_charging_on",
        service_name=REMOTE_CTL_HEALTHY_CHARGING_ON,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_HEALTHY_CHARGING_OFF,
        translation_key="healthy_charging_off",
        icon="mdi:battery-heart-outline",
        method_name="healthy_charging_off",
        service_name=REMOTE_CTL_HEALTHY_CHARGING_OFF,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_BLE_KEY_RESTART,
        translation_key="ble_key_restart",
        icon="mdi:bluetooth-settings",
        method_name="ble_key_restart",
        service_name=REMOTE_CTL_BLE_KEY_RESTART,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_FOTA_DOWNLOAD,
        translation_key="fota_download",
        icon="mdi:download",
        method_name="fota_download",
        service_name=REMOTE_CTL_FOTA_DOWNLOAD,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_FOTA_INSTALL,
        translation_key="fota_install",
        icon="mdi:package-down",
        method_name="fota_install",
        service_name=REMOTE_CTL_FOTA_INSTALL,
    ),
)
