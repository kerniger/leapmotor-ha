...
BUTTON_SPECS: tuple[RemoteActionSpec, ...] = (
    ...
    RemoteActionSpec(
        action=REMOTE_CTL_STEERING_WHEEL_HEAT_ON,
        translation_key="steering_wheel_heat_on",
        icon="mdi:steering",
        method_name="steering_wheel_heat_on",
        service_name=REMOTE_CTL_STEERING_WHEEL_HEAT_ON,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_STEERING_WHEEL_HEAT_OFF,
        translation_key="steering_wheel_heat_off",
        icon="mdi:steering",
        method_name="steering_wheel_heat_off",
        service_name=REMOTE_CTL_STEERING_WHEEL_HEAT_OFF,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_FUEL_HEATING_ON,
        translation_key="fuel_heating_on",
        icon="mdi:fire",
        method_name="fuel_heating_on",
        service_name=REMOTE_CTL_FUEL_HEATING_ON,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_FUEL_HEATING_OFF,
        translation_key="fuel_heating_off",
        icon="mdi:fire-off",
        method_name="fuel_heating_off",
        service_name=REMOTE_CTL_FUEL_HEATING_OFF,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_REARVIEW_MIRROR_HEAT_ON,
        translation_key="rearview_mirror_heat_on",
        icon="mdi:mirror",
        method_name="rearview_mirror_heat_on",
        service_name=REMOTE_CTL_REARVIEW_MIRROR_HEAT_ON,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_REARVIEW_MIRROR_HEAT_OFF,
        translation_key="rearview_mirror_heat_off",
        icon="mdi:mirror",
        method_name="rearview_mirror_heat_off",
        service_name=REMOTE_CTL_REARVIEW_MIRROR_HEAT_OFF,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_SUNROOF_OPEN,
        translation_key="open_sunroof",
        icon="mdi:car-convertible",
        method_name="open_sunroof",
        service_name=REMOTE_CTL_SUNROOF_OPEN,
    ),
    RemoteActionSpec(
        action=REMOTE_CTL_SUNROOF_CLOSE,
        translation_key="close_sunroof",
        icon="mdi:car-convertible",
        method_name="close_sunroof",
        service_name=REMOTE_CTL_SUNROOF_CLOSE,
    ),
    RemoteActionSpec(
    ...
    RemoteActionSpec(
        action=REMOTE_CTL_PREPARE_CAR,
        translation_key="prepare_car",
        icon="mdi:car-clock",
        method_name="prepare_car",
        service_name=REMOTE_CTL_PREPARE_CAR,
    ),
)
