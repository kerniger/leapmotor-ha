...
REMOTE_ACTION_SPECS: dict[str, RemoteActionSpec] = {
    ...
    REMOTE_CTL_FUEL_HEATING_ON: RemoteActionSpec(cmd_id="380", cmd_content='{"value":"1"}'),
    REMOTE_CTL_FUEL_HEATING_OFF: RemoteActionSpec(cmd_id="380", cmd_content='{"value":"0"}'),
    ...
    REMOTE_CTL_SUNROOF_OPEN: RemoteActionSpec(cmd_id="300", cmd_content='{"value":"open"}'),
    REMOTE_CTL_SUNROOF_CLOSE: RemoteActionSpec(cmd_id="300", cmd_content='{"value":"close"}'),
    REMOTE_CTL_AC_ON: RemoteActionSpec(
        cmd_id="170",
        cmd_content='{"circle":"out","mode":"nohotcold","operate":"open","position":"all","temperature":"24","windlevel":"4","wshld":"1"}',
    ),
    REMOTE_CTL_AC_OFF: RemoteActionSpec(
        cmd_id="170",
        cmd_content='{"circle":"out","mode":"nohotcold","operate":"close","position":"all","temperature":"24","windlevel":"4","wshld":"1"}',
    ),
    REMOTE_CTL_PREPARE_CAR: RemoteActionSpec(cmd_id="360", cmd_content="{}"),
}
